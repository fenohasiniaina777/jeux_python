...
class Piozla_level2(QFrame):
    def __init__(self, checkbox_state, parent):
        ...
        # # fond-image
        # # image du fond
        img_fond = QPixmap("./images/png/tissus/taquin3.png")
        ...
        self.goal_state = list(range(1, 16)) + [0],
...
# fenetre a gauche
        ...
        # label_level_jeu
        self.label_level = QLabel("Level 2", self.win_gauche)
...
# plateau du jeu a droite
    ...
    def draw_board(self):
        ...
        # btn taille
        btn_width = (frame_width - 40) // 4
        btn_height = (frame_height - 40) // 4
        ...
        for i in range(4):
            for j in range(4):
                ...
                if value != 0:
                    ...
                    btn.setIcon(QIcon("./images/png/tissus/taquin9.png"))
    ...
    def try_move(self, i,j):  
        ...
        if abs(empty_i - i) + abs(empty_j - j)== 1:
            ...
            if self.is_solved():
                ...
                self.parent.aller_niveau_suivant("Avancé")
