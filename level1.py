...
class Piozla_level1(QFrame):
    def __init__(self, checkbox_state, parent):
        ...
        # # fond-image
        # # image du fond
        img_fond = QPixmap("./images/png/tissus/taquin5.png")
...
# fenetre a gauche
        ...
        # label_level_jeu
        self.label_level = QLabel("Level 1", self.win_gauche)
...
# plateau du jeu a droite
        ...
        self.plateau_puzzle.setStyleSheet("""
                                        background-image: url(./images/png/tissu3.webp);
        ...
        for i in range(3):
            for j in range(3):
                if counter == 9:
                    tiles[0] = None
                    break
                tile = pixmap.copy(j * w, i * w, w,w).scaled(200,200)
                tiles[counter] = tile
                counter += 1
        return tiles
    ...
    def draw_board(self):
        ...
        # btn taille
        btn_width = (frame_width -10) // 3
        btn_height = (frame_height - 10) // 3
        ...
        for i in range(3):
            for j in range(3):
                ...
                if value != 0:
                    ...
                    btn.setIcon(QIcon("./images/png/tissus/vide.jpg"))
        ...
        for i in range(3):
            for j in range(3):
                ...
                self.label_timer.setStyleSheet("""
                            ...
                            font-family: 'Digital-7 Mono', 'Courier New', monospace;
                            """)
                self.temps_restant = QTime(0,5,0)
                self.label_timer.setText(f"{self.temps_restant.toString("hh:mm:ss")}")
                self.step = 0
                self.nbr_pas.setText(f"{self.step}")
                self.timer_en_cours = False
    ...
    def try_move(self, i,j):  
        ...
        if abs(empty_i - i) + abs(empty_j - j)== 1:
            ...
            if self.is_solved():
                ...
                self.parent.aller_niveau_suivant("Intermédiaire")
    ...
    def is_solved(self):
        ...
        return numbers_without_zero == list(range(1, 9))
    ...
    def update_board(self):
        ...
        # btn taille
        btn_width = (frame_width - 40) // 3
        btn_height = (frame_height - 40) // 3
